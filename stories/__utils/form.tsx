import { AnyFormAPI } from "@/components/inputs";

import { ComponentType } from "react";

import { FormApi, FormValidationErrorMap, useForm } from "@tanstack/react-form";
...
export const FormRenderer = <P, F extends AnyFormAPI>({
  ...
  form.store.state.errorMap = props.form.store.state.errorMap;
